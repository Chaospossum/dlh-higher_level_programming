#!/usr/bin/python3
"""Defines a Rectangle class with size comparison."""
...
class Rectangle:
    ...
    def __repr__(self):
        """Return a string for recreating the rectangle via eval()."""
        return f"Rectangle({self.__width}, {self.__height})"

    def __del__(self):
        """Print a message and decrement the counter on deletion."""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
